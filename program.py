...
path2config ='workspace/exported-models/model/pipeline.config'
path2model = 'workspace/exported-models/model/'
...
with tf.Session() as sess:
	ckpt = tf.compat.v1.saved_model.loader.load(sess, "workspace/exported-models/model/model.ckpt","workspace/exported-models/model/saved_model")
